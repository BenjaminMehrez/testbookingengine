...
## ℹ️ Original Project Features (Legacy)
*Base functionality preserved from the original PMS:*

- Create, delete and check bookings for each room.
- Check room availability.
- Find bookings by code or customer name.
- Dashboard with incoming/outcoming customers and total invoiced.
- **Note:** `DEBUG` is set to `TRUE` for this assessment environment.